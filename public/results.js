...
var join = " FROM individuals JOIN demographics ON individuals.subject_id = demographics.subject_id JOIN medical_history ON demographics.subject_id = medical_history.subject_id ";
var columnsNames = "";
for(i = 0; i < arrCol.length; i++){
    columnsNames += arrCol[i] + ", ";
} 
var firstPart = "SELECT " + columnsNames.substring(0, str.length - 2) + join;
myQuery ="";
